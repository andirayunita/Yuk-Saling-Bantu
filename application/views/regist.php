...
<body class="hold-transition login-page" style="background-image: url('https://images.unsplash.com/photo-1512977851705-67ee4bf294f4?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1460');">
  <div class="login-box" style="margin-top:100px; padding-bottom: 80px;">
    <div class="login-logo">
      <a href="<?= base_url('auth/login'); ?>"><h2><b>Yuk Kita Bantu</b></h2></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
      <p class="login-box-msg"><i class="fa fa-lock"></i> Registrasi akun baru</p>

      <?= $this->session->flashdata('pesan'); ?>
      <form action="<?= base_url('auth/regist'); ?>" method="post">
        <div class="form-group has-feedback">
          <input type="text" name="nama" class="form-control" placeholder="Masukkan Nama" value="<?= set_value('nama', ''); ?>" autocomplete="off">
      ...
      <a href="<?= base_url('auth/login') ?>" class="text-center text-success">Sudah punya akun? Silahkan login.</a>
